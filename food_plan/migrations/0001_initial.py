# Generated by Django 4.0 on 2023-10-02 17:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50, verbose_name='Алергены')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Client',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='client', serialize=False, to='auth.user', verbose_name='Пользователь')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50, verbose_name='Тип блюда')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_name', models.CharField(choices=[('1', '1 мес.'), ('3', '3 мес.'), ('6', '6 мес.'), ('12', '12 мес.')], max_length=8, verbose_name='Название подписки')),
                ('date', models.DateTimeField(db_index=True, default=django.utils.timezone.now, verbose_name='Дата платежа')),
                ('transaction_id', models.CharField(max_length=40, null=True, verbose_name='id транзакции')),
                ('status', models.CharField(max_length=40, null=True, verbose_name='Cтатус оплаты')),
                ('price', models.DecimalField(decimal_places=0, max_digits=6, null=True, verbose_name='Цена')),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transaction', to='food_plan.client', verbose_name='Клиент')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergens', models.ManyToManyField(blank=True, related_name='meal_plans', to='food_plan.Allergen', verbose_name='Аллергены')),
                ...
                ('dish_types', models.ManyToManyField(max_length=50, to='food_plan.DishType', verbose_name='Тип блюда')),
                ('recipes', models.ManyToManyField(blank=True, related_name='meal_plans', to='food_plan.Recipe', verbose_name='Рецепты')),
            ],
            options={
